...
exports.MockTradingProvider = void 0;
...
class MockTradingProvider {
     ...
     */
    setMockBalance(balance, buyingPower) {
     ...
     */
    addMockPosition(symbol, quantity, averagePrice) {
        const position = {
            symbol,
            quantity,
            averagePrice,
...
exports.MockTradingProvider = MockTradingProvider;
