 ...
 */
import { OHLCV, Quote, SymbolInfo, MarketDataSubscription, MarketDataEvent, Timeframe } from '@jware-trader8/types';
/**
...
export interface IDataProvider {
     ...
     */
    getHistoricalData(symbol: string, timeframe: Timeframe, startDate: Date, endDate: Date, options?: {
        limit?: number;
     ...
     */
    subscribe(symbols: string[], dataTypes: ('quotes' | 'trades' | 'bars')[], callback: (event: MarketDataEvent) => void): Promise<MarketDataSubscription>;
    /**
...
export interface IMultiDataProvider {
     ...
     */
    getHistoricalDataWithFailover(symbol: string, timeframe: Timeframe, startDate: Date, endDate: Date): Promise<OHLCV[]>;
    /**
